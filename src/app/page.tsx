  ...
  return (
    <>
        ...
        <main className="container mx-auto flex flex-col items-center px-4 pt-36 sm:pt-48">
          ...
          <section id="inicio" className="z-10 text-center w-full max-w-5xl">
              ...
              <div className="mt-10 flex flex-col items-center gap-8">
                <iframe id="panda-acafbd77-0f62-449f-b1cc-cc9497498103" src="https://player-vz-5f1b2962-e2c.tv.pandavideo.com/embed/?v=acafbd77-0f62-449f-b1cc-cc9497498103" style={{border: 'none', maxWidth: '720px', width: '100%', height: '360px'}} allow="accelerometer;gyroscope;autoplay;encrypted-media;picture-in-picture" allowFullScreen={true} fetchPriority="high"></iframe>
             ...
             <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <GradientCard className="flex flex-col">
                  ...
                  <CardContent className="flex flex-col flex-grow p-6">
                    ...
                    <Button 
                      size="lg" 
                      className="w-full bg-red-600 hover:bg-red-700 text-lg font-bold h-14 mt-auto transition-transform duration-200 hover:scale-105"
      ...
      <Dialog open={isUpsellOpen} onOpenChange={setIsUpsellOpen}>
        <DialogContent className="sm:max-w-md bg-card border-accent/50 text-white text-center p-8">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold uppercase tracking-wider">ESPERE! OFERTA ESPECIAL!</DialogTitle>
            <DialogDescription className="text-gray-300 pt-4 text-base">
              Atualize para o Pacote Premium e receba todos os bônus por um preço que você não vai acreditar.
            </DialogDescription>
          </DialogHeader>
          <div className="my-8">
